...
Tutto il resto è sullo **Slave**: encoder, LED ring, DMX, FFT, wireless, storage NVS (il relè audio non è più presente nell’hardware attuale).
...
| 8, 9 | DMX TX, DE |
| 10 | Riservato / non usato (in passato Relay audio) |
| 11 | Strobo |
...
| 0x22 | M→S | Riservato (ex Relay ON/OFF) |
